              ...
              >
                <div className="align-text-center">
                  ...
                  <p style={{margin: "2.5% 10% 2.5% 10%"}}>
                    Natively from Miami, I have always lived in the sunny south
                    of Florida. I graduated from Washington University in St.
                    Louis in 2019, with a Bachelors of Science in Architecture.
                    I then went on to work for Plaza Construction where i was
                    able to fulfill my dreams of being integrated with the
                    fields of building. Hungry for a new frontier, as well as
                    given an oppurtunity from Covid, i pursued my new career in
                    Full Stack Web Development. This has allowed me to employ my
